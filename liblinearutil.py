...
import os, sys
#sys.path.append(f"{os.path.dirname(os.path.abspath(__file__))}/liblinear_multicore")
#print(sys.path)
from liblinear_multicore.liblinear import *
from liblinear_multicore.liblinear import __all__ as liblinear_all
from liblinear_multicore.liblinear import scipy, sparse
from liblinear_multicore.commonutil import *
